...
public class ReqlAst {
     ...
     */
    public <T> T run(Connection conn) throws Throwable {
     ...
     * @return The result of this query
     */
    public <T> T run(Connection conn, OptArgs runOpts) throws Throwable {
     ...
     */
    public <T, P> T run(Connection conn, Class<P> pojoClass) throws Throwable {
     ...
     * @return The result of this query (either a {@code P or a Cursor<P>}
     */
    public <T, P> T run(Connection conn, OptArgs runOpts, Class<P> pojoClass) throws Throwable {
        return conn.run(this, runOpts, Optional.of(pojoClass));
    }

    public void runNoReply(Connection conn) throws Throwable {
        conn.runNoReply(this, new OptArgs());
    }

    public void runNoReply(Connection conn, OptArgs globalOpts) throws Throwable {
