...
public class Connection implements Closeable {
    ...
    public void connect() throws TimeoutException, Throwable {
    ...
    public Connection reconnect() {
        try {
            ...
            throw new RuntimeException(toe.getMessage());
        }
    }

    public Connection reconnect(boolean noreplyWait, Optional<Long> timeout) throws TimeoutException, Throwable {
    ...
    void connect(Optional<Long> timeout) throws TimeoutException, Throwable {
    ...
    public void close(boolean shouldNoreplyWait) throws Throwable {
        // disconnect
        try {
     ...
     */
    private Future<Response> sendQuery(Query query, Optional<Long> deadline) throws Throwable {
     ...
     * @param query    the query to execute.
     */
    private void sendQueryNoreply(Query query) throws Throwable  {
        // check if response pump is running
        if (!exec.isShutdown() && !exec.isTerminated()) {
            try {
                lock.lock();
    ...
    void runQueryNoreply(Query query) throws Throwable {
        sendQueryNoreply(query);
    }

    <T> T runQuery(Query query) throws Throwable {
        return runQuery(query, Optional.empty());
    }

    <T, P> T runQuery(Query query, Optional<Class<P>> pojoClass) throws Throwable {
     ...
     * @return
     */
    <T, P> T runQuery(Query query, Optional<Class<P>> pojoClass, Optional<Long> timeout) throws Throwable {
        Response res = null;
        try {
    ...
    public void noreplyWait() throws Throwable {
    ...
    public <T, P> T run(ReqlAst term, OptArgs globalOpts, Optional<Class<P>> pojoClass) throws Throwable {
        return run(term, globalOpts, pojoClass, Optional.empty());
    }

    public <T, P> T run(ReqlAst term, OptArgs globalOpts, Optional<Class<P>> pojoClass, Optional<Long> timeout) throws Throwable {
    ...
    public void runNoReply(ReqlAst term, OptArgs globalOpts) throws Throwable  {
        setDefaultDB(globalOpts);
        globalOpts.with("noreply", true);
        runQueryNoreply(Query.start(newToken(), term, globalOpts));
    }

    Future<Response> continue_(Cursor cursor) throws Throwable {
        return sendQuery(Query.continue_(cursor.token), Optional.empty());
    }


    void stop(Cursor cursor) throws Throwable {
