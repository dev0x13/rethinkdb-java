...
public static class FormatOptions{
    ...
    public FormatOptions(OptArgs args){
        this.rawTime = true;//((Datum)args.getOrDefault("time_format",
    ...
    public static Object convertPseudo(Map<String, Object> value, FormatOptions fmt) {
        ...
        switch (reqlType) {
            case TIME:
                return value;//fmt.rawTime ? value : getTime(value);
            case GROUPED_DATA:
    ...
    public static Map<String,Object> toBinary(byte[] data){
        ...
        mob.with("data", Base64.encodeToString(data, Base64.NO_WRAP));
        return mob;
    }
}
